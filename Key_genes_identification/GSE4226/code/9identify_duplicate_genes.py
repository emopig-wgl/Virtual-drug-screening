...
# 读取CSV文件
input_file = "C:/Users/lenovo/Desktop/文章4/数据集筛选/筛选重复基因/GSE4226/top25genes_python.csv"  # 替换为你的CSV文件路径
output_file = "C:/Users/lenovo/Desktop/文章4/数据集筛选/筛选重复基因/GSE4226/duplicate_gene_top25version.csv"  # 输出文件名
