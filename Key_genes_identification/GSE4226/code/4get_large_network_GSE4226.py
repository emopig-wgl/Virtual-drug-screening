...
df2 = pd.read_csv('C:/Users/lenovo/Desktop/文章4/数据集筛选/筛选重复基因/GSE4226/GSE4226_string_interactions_short_0.4.tsv',sep='\t')  #opoid
...
s = pd.read_csv('C:/Users/lenovo/Desktop/文章4/数据集筛选/筛选重复基因/GSE4226/GSE4226_DEGs_limma.csv')
...
df.to_csv('C:/Users/lenovo/Desktop/文章4/数据集筛选/筛选重复基因/GSE4226/deg_ppi_0.4_clean.tsv',sep='\t')
...
df.to_csv('C:/Users/lenovo/Desktop/文章4/数据集筛选/筛选重复基因/GSE4226/deg_ppi_large.csv')
...
df.to_csv('C:/Users/lenovo/Desktop/文章4/数据集筛选/筛选重复基因/GSE4226/deg_ppi_nodes_large.csv')
