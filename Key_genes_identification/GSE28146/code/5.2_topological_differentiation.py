...
compl = network_complex(patp + f'/GSE28146_string_interactions_short_0.4.tsv', patp + '/GSE28146_DEGs_limma_split.csv')
df = pd.DataFrame()
df['node'] = compl.nodes
...
merged_df.to_csv('C:/Users/lenovo/Desktop/文章4/数据集筛选/筛选重复基因/GSE28146/ph_cocaine_norm_statistics_0.4.csv')
