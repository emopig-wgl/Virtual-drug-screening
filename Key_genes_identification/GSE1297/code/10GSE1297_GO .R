...
# 2. 读取差异表达文件
# ---------------------------
input_file <- "C:/Users/lenovo/Desktop/文章4/数据集筛选/筛选重复基因/GSE1297/GSE1297_DEGs_limma_split.csv"
...
# 10. 绘制弦图并加入双Legend
# ---------------------------
output_pdf <- "C:/Users/lenovo/Desktop/GOPHOTO/GSE1297GOChord_plot_clean.pdf"
...
# ---------------------------
write.csv(ego_res,
          "C:/Users/lenovo/Desktop/文章4/数据集筛选/筛选重复基因/GSE1297/GO_enrichment_results.csv",
          row.names = FALSE)
...
# 保存图片
ggsave(
  filename = "C:/Users/lenovo/Desktop/GOPHOTO/GSE1297_GO_bubble_chart.png",
  plot = p_bubble,
  width = 8,
  height = 6,
  dpi = 600
