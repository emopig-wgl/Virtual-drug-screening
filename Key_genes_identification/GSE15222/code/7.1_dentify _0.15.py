...
##运行4次，每次更改文件
file_names = ['C:/Users/lenovo/Desktop/文章4/数据集筛选/筛选重复基因/GSE15222/ph_cocaine_norm_statistics_0.15.csv']
...
# 保存结果到新的CSV文件
top_25_nodes.to_csv('C:/Users/lenovo/Desktop/文章4/数据集筛选/筛选重复基因/GSE15222/top_25_nodes_0.15.csv', index=False)
