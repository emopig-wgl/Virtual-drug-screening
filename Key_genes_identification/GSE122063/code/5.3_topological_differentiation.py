...
patp = 'C:/Users/lenovo/Desktop/文章4/数据集筛选/筛选重复基因/GSE122063/'
compl = network_complex(patp + f'/GSE122063_string_interactions_short_0.7.tsv', patp + '/GSE122063_DEGs_limma.csv')
df = pd.DataFrame()
df['node'] = compl.nodes
...
merged_df.to_csv('C:/Users/lenovo/Desktop/文章4/数据集筛选/筛选重复基因/GSE122063/ph_cocaine_norm_statistics_0.7.csv')
