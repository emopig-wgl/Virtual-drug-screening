...
setwd("C:/Users/lenovo/Desktop/文章4/数据集筛选/GSE36980")
...
gse <- getGEO(
  filename = "C:/Users/lenovo/Desktop/文章4/数据集筛选/GSE36980/GSE36980_series_matrix.txt/GSE36980_series_matrix.txt"
)
...
p <- ggplot(
  ...
  theme_bw() +
  labs(
    title = "GSE36980 Differential Expression (limma)",
    x = "log2 Fold Change",
    y = "-log10(P value)"
  )

ggsave(
  filename = "GSE36980_volcano_limma.png",
  plot = p,
  width = 6,
  height = 5
)
...
ggsave(
  filename = "GSE36980_volcano_limma.pdf",
  plot = p,
  width = 6,
  height = 5
)
