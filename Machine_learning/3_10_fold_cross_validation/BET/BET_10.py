...
# path_smi = f'/share/home/u2415173011/Aldisease/TOP25_CHEMBL/BET/{model}/'
# path_label = f'/share/home/u2415173011/Aldisease/TOP25_CHEMBL/BET/{model}/'
...
#         # 生成AE特征
#         # cmd = 'cddd --input /public/home/chenlong666/desktop/my_desk2/data/{}/{}_regression_train_{}.smi\
#         #         --out /public/home/chenlong666/desktop/result/AE_csv/{}_train_AE_{}.csv \
#         #         --smiles_header smiles'.format(model, model, fold, model, fold)
#         # os.system(cmd)
#         #
#         # cmd = 'cddd --input /public/home/chenlong666/desktop/my_desk2/data/{}/{}_regression_valid_{}.smi\
#         #                 --out /public/home/chenlong666/desktop/result/AE_csv/{}_valid_AE_{}.csv \
#         #                 --smiles_header smiles'.format(model, model, fold, model, fold)
#         # os.system(cmd)
#         #
#         # cmd = 'cddd --input /public/home/chenlong666/desktop/my_desk2/data/{}/{}_regression_test_{}.smi\
#         #                 --out /public/home/chenlong666/desktop/result/AE_csv/{}_test_AE_{}.csv \
#         #                 --smiles_header smiles'.format(model, model, fold, model, fold)
#         # os.system(cmd)
...
#         #     --trainpref "/public/home/chenlong666/desktop/my_desk2/data/{}/{}_regression_train_{}.smi" \
#         #     --validpref "/public/home/chenlong666/desktop/my_desk2/data/{}/{}_regression_valid_{}.smi" \
...
#         # cmd = 'cp "/public/home/chenlong666/desktop/my_desk2/data/{}/{}_regression_train_{}.label" \
#         #           "/public/home/chenlong666/desktop/PretrainModels/examples/data/regression_example/label/train.label"'.format(
#         #     model, model,fold)
#         # os.system(cmd)
#         # cmd = 'cp "/public/home/chenlong666/desktop/my_desk2/data/{}/{}_regression_valid_{}.label" \
...
#         # train_smiles = r'/public/home/chenlong666/desktop/my_desk2/data/{}/{}_regression_train_{}.smi'.format(model, model,fold)
...
#         #     --target_file "/public/home/chenlong666/desktop/my_desk2/data/{}/{}_regression_train_{}.smi" \
...
#         #             "/public/home/chenlong666/desktop/PretrainModels/examples/data/regression_example/" \
#         #             --dict_file "/public/home/chenlong666/desktop/PretrainModels/examples/data/regression_example/dict.txt" \
#         #             --target_file "/public/home/chenlong666/desktop/my_desk2/data/{}/{}_regression_test_{}.smi" \
...
#         #     "/public/home/chenlong666/desktop/PretrainModels/examples/data/regression_example/" \
#         #     --dict_file "/public/home/chenlong666/desktop/PretrainModels/examples/data/regression_example/dict.txt" \
#         #     --target_file "/public/home/chenlong666/desktop/my_desk2/data/{}/{}_regression_valid_{}.smi" \
...
#     #     X_train_1 = np.load(path_BET_npy + '{}_train_BET_{}.npy'.format(model,fold),
#     #                         allow_pickle=True)
#     #     X_train_2 = np.load(path_BET_npy + '{}_valid_BET_{}.npy'.format(model,fold),
#     #                         allow_pickle=True)
#     #     X_train = np.concatenate((X_train_1, X_train_2))
#     #     print('shape of X_train_1:', np.shape(X_train_1))
#     #     print('shape of X_train_2:', np.shape(X_train_2))
#     #     print('shape of X_train:', np.shape(X_train))
#     #     X_test = np.load(path_BET_npy + '{}_test_BET_{}.npy'.format(model,fold),
#     #                      allow_pickle=True)
...
# ===== 路径 =====
base_path = f'/share/home/u2415173011/Aldisease/TOP25_CHEMBL'
path_smi = f'{base_path}/BET/{model}/'
path_ae  = f'{base_path}/AE/{model}/'

# 创建目录（防止不存在）
os.makedirs(path_ae, exist_ok=True)

# ===== 读取数据 =====
data = np.array(open(path_smi + f'{model}.smi').readlines())
y_val = np.array([eval(i.strip()) for i in open(path_smi + f'label_{model}.csv')])

print('data size:', data.shape)
print('label size:', y_val.shape)
...
for train_idx, test_idx in kf.split(data):
    ...
    write_file(f'{path_ae}/{model}_regression_train_{fold}.smi', X_train)
    write_file(f'{path_ae}/{model}_regression_valid_{fold}.smi', X_valid)
    write_file(f'{path_ae}/{model}_regression_test_{fold}.smi', X_test)

    print("✔ SMILES files generated")

    # ===== 路径检查 =====
    train_file = f'{path_ae}/{model}_regression_train_{fold}.smi'
    valid_file = f'{path_ae}/{model}_regression_valid_{fold}.smi'
    test_file  = f'{path_ae}/{model}_regression_test_{fold}.smi'

    for fpath in [train_file, valid_file, test_file]:
        if not os.path.exists(fpath):
            print("❌ missing:", fpath)
            exit()

    # ===== BET 特征生成 =====
    def run_bt(input_file, output_file):
        cmd = f'''/share/home/u2415173011/.conda/envs/bet/bin/python \
...
--save_feature_path {output_file}
'''
        print("Running:", input_file)
        os.system(cmd)

    run_bt(train_file, f'{base_path}/BET/{model}_train_BET_{fold}.npy')
    run_bt(valid_file, f'{base_path}/BET/{model}_valid_BET_{fold}.npy')
    run_bt(test_file,  f'{base_path}/BET/{model}_test_BET_{fold}.npy')

t_end = time.time()
print('total time:', (t_end - t_start) / 3600, 'h')